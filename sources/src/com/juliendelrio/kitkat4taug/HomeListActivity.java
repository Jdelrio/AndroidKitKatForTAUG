 ...
 * {@link SubjectActivity} representing item details. On tablets, the activity
 ...
 */
public class HomeListActivity extends FragmentActivity implements HomeListFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.item_detail_container) != null) {
			...
			((HomeListFragment) getSupportFragmentManager().findFragmentById(R.id.item_list))
